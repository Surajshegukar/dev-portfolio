...
import { SurajShegukarMark } from "@/components/surajshegukar-mark";
import { SurajShegukarWordmark } from "@/components/surajshegukar-wordmark";
      ...
      <BrandContextMenu>
        <div className="grid grid-cols-[2rem_1fr]">
          ...
          <div className="screen-line-after flex items-center justify-center pr-8 after:z-1">
            <SurajShegukarMark className="h-8 w-auto sm:h-12" />
          </div>
          ...
          <div className="screen-line-after flex items-center justify-center pr-8 after:z-1">
            <SurajShegukarWordmark className="h-18 lg:h-28" />
          </div>
        </div>
      </BrandContextMenu>
    </Panel>
