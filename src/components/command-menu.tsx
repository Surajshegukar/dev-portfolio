...
import { SurajShegukarMark, getMarkSVG } from "./surajshegukar-mark";
import { getWordmarkSVG } from "./surajshegukar-wordmark";
...
const PRODUCT_LINKS: CommandLinkItem[] = [
  {
    ...
    icon: Icons.react,
    keywords: ["forgedock", "productivity", "tools", "pdf", "images"],
    openInNewTab: true,
  },
];
  ...
  return (
    <>
      ...
      <div className="absolute inset-x-0 bottom-0 flex h-10 items-center justify-between gap-2 border-t bg-zinc-100/30 px-4 text-xs font-medium dark:bg-zinc-800/30">
        <SurajShegukarMark className="size-6 text-muted-foreground" aria-hidden />
